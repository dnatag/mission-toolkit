...
├── cli-reference.md           # CLI command reference (auto-generated by `m init`)
...
All CLI commands are documented in `libraries/cli-reference.md` (auto-generated by `m init` from the Cobra command definitions):
