...
```bash
# macOS (Intel)
curl -L https://github.com/dnatag/mission-toolkit/releases/download/v1.1.2/mission-toolkit_Darwin_x86_64.zip -o m.zip
unzip m.zip && chmod +x m && sudo mv m /usr/local/bin/

# macOS (Apple Silicon)
curl -L https://github.com/dnatag/mission-toolkit/releases/download/v1.1.2/mission-toolkit_Darwin_arm64.zip -o m.zip
unzip m.zip && chmod +x m && sudo mv m /usr/local/bin/

# Linux (amd64)
curl -L https://github.com/dnatag/mission-toolkit/releases/download/v1.1.2/mission-toolkit_Linux_x86_64.zip -o m.zip
unzip m.zip && chmod +x m && sudo mv m /usr/local/bin/

# Linux (arm64)
curl -L https://github.com/dnatag/mission-toolkit/releases/download/v1.1.2/mission-toolkit_Linux_arm64.zip -o m.zip
unzip m.zip && chmod +x m && sudo mv m /usr/local/bin/

# Windows (PowerShell)
Invoke-WebRequest -Uri https://github.com/dnatag/mission-toolkit/releases/download/v1.1.2/mission-toolkit_Windows_x86_64.zip -OutFile m.zip
